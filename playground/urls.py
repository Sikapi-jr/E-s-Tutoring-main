...
urlpatterns = [
    ...
    # Admin email logs
    path('admin/email-logs/', views.AdminEmailLogsView.as_view(), name='admin-email-logs'),
    ...
    path('group-tutoring/student-quizzes/<int:enrollment_id>/', group_tutoring_views.student_quizzes, name='student-quizzes'),
