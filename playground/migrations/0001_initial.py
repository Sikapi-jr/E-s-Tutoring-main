    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ('rateOnline', models.DecimalField(decimal_places=2, default=35.00, max_digits=10)),
                ('rateInPerson', models.DecimalField(decimal_places=2, default=60.00, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('parent', models.CharField(default='ERROR', max_length=50)),
                ('student', models.CharField(default='ERROR', max_length=50)),
                ('tutor', models.CharField(default='ERROR', max_length=50)),
