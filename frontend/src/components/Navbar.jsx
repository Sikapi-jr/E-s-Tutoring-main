...
const getRoleConfig = (BASE) => ({
  superuser: {
    ...
    sessions: [],
    cal:    [],
    single: [BASE.Inv, BASE.GroupTutoring, BASE.Complaints, BASE.UserSearch, BASE.BatchAddHours, BASE.HoursOverview, BASE.TestEmail, BASE.DiscountReg, BASE.BulkEmails, BASE.EmailLogs],
  },
  parent: {
