...
const getRoutes = (t) => ({
  ...
  Request: { to: "/request-reply",     label: t('navigation.tutoringRequests') },
  Replies: { to: "/request-reply",     label: t('navigation.tutoringRequests') },
  ...
  GroupTutoring: { to: "/group-tutoring", label: 'Group Tutoring' },
  ...
  DiscountReg: { to: "/admin-discount-registration", label: t('admin.discountRegistration', '10% Discount') },
  BulkEmails: { to: "/admin-bulk-emails", label: t('admin.bulkEmails', 'Bulk Emails') },
...
const getRoleConfig = (BASE) => ({
  superuser: {
    ...
    sessions: [],
    cal:    [],
    single: [BASE.Inv, BASE.Reports, BASE.GroupTutoring, BASE.Complaints, BASE.UserSearch, BASE.BatchAddHours, BASE.HoursOverview, BASE.TestEmail, BASE.DiscountReg, BASE.BulkEmails, BASE.EmailLogs],
  },
  parent: {
  ...
  tutor: {
    main:   [BASE.Home, BASE.MyStudents, BASE.Dash, BASE.Hours, BASE.Events, BASE.Reports],
    tutor:  [],
    sessions: [],
    cal:    [],
    single: [],
